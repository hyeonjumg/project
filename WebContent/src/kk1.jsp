...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>해외음식</i></h1>
  <img src="img/hh1.png" class="myImage"/>
<hr width =30% color="gray" align="left" size=5/>
<h3> 매장 명 : 레프레미스 (마카롱)</h3>
<h4> 마카롱(marcaron)은 작고 동그란 모양의 머랭 크러스트 사이의 잼, 가나슈, 버터크림<br>
등의 필링을 채워 만든 프랑스산 쿠키이며, 젊은이들 사이에 인기 있는 과자이다.
</h4>
<input type="button" value="CLICK" onClick="window.open('http://www.lespremices.co.kr/shop/main/index.php')">
