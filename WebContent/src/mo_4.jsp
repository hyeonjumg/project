...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>모범맛집</i></h1>
  <img src="img/mo_4.jpg" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 이가네떡볶이</h3>
<h4>부산깡통시장 내에 위치하고 있는 떡볶이 맛집으로 백종원의 삼대천왕 떡볶이 편에서 우승한 집이다.<br>
 천연재료를 사용하여 고추장을 직접 만들어 텁텁한 맛없이 깔끔한 양념을 자랑한다. 가마솥 중탕으로<br>
  물을 사용하지 않고 무에서 나오는 즙만으로 떡볶이를 만드는 것으로 유명하다. 즙이 빠진 무의 독특한<br>
  식감은 무말랭이처럼 씹는 맛이 좋아 떡볶이의 맛을 한층 더 살려준다. 기본 양념이 맛있기 때문에 튀김과<br>
  버무려 먹어도 좋다. 다른 곳에서는 느낄 수 없는 색다른 맛을 느낄 수 있다.<br>
   부드러운 튀김옷을 입은 소세지 핫도그도 인기. 핫도그를 설탕에 찍어먹으면 또 다른 맛을 느낄 수 있다.
</h4>
