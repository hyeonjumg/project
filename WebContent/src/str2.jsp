...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>레스토랑</i></h1>
  <img src="img/srt2.jpg" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 로코 8</h3>
<h4> 게스트로 펍. 다양한 크래프트 비어와 정통 수제 훈연 바비큐등을 제공하는 곳. 메뉴로는 바베큐,<br>
버거, 피자, 스테이크, 파스타, 샐러드 등이 있다. 6종 샘플러를 제공하며 크래프트 맥주외에 병맥주,<br>
와인, 위스키, 칵테일 등을 제공한다. 얼티메이트 바비큐 플래터, 로코 립아이 스테이크 등이 인기메뉴<br>
매장은 넓은편으로 고급스러운 분위기. 홀과 야외 테라스로 구성된다..</h4>
<input type="button" value="CLICK" onClick="window.open('http://loco8.tistory.com/')">
