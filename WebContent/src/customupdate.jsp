  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
 		...
 		<h3 style="text-align: left;"><i>고객센터 [묻고 답하기]</i></h3>
 			<div class="row">
 			<form method="post" action="customupdateAction.jsp?customID=<%= customID %>">
 			<table class="table table-striped" style="text-align: center;  border: 1px solid #dddddd">
 						...
 						<tbody>
 							<tr>
 								<td><input type="text" class="form-control" placeholder="글 제목" name="customTitle" maxlength="50" value="<%= custom.getCustomTitle() %>"></td>
 								</tr>
 								<tr>
 								<td><textarea class="form-control" placeholder="글 내용" name="customContent" maxlength="2048" style="height: 350px;"><%= custom.getCustomContent() %></textarea></td>
 								</tr>
