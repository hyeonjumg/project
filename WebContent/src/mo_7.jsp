...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>모범맛집</i></h1>
  <img src="img/mo_7.jpg" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 한채당</h3>
<h4>담장이 뚫린 전통 한옥 건물에서 다양한 코스로 즐기는 한정식 전문점이다.<br>
 복도로 연결된 실내는 4인실부터 60인실까지 다양한 룸이 200석 규모를 갖추어져 있다.<br>
  정식(22000)은 점심특선으로 점심시간에만 이용이 가능하니 참고할 것
</h4>
<input type="button" value="CLICK" onClick="window.open('http://www.hancorp.co.kr')">
