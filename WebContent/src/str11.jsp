...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>레스토랑</i></h1>
  <img src="img/str11.jpg" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 온더블랙</h3>
<h4>돌판에 직접 익혀 먹는 스테이크. 스테이크를 400도의 뜨거운 돌판 위에서 소비자가 직접 구우면서<br>
 원하는 굽기정도를 조절가능한 것이 특징. 메뉴로는 샐러드, 파스타, 스테이크, 리조또 등이 있으며 세트 메뉴가<br>
  준비되어 있고, 고기는 35일 숙성 냉장육을 사용한다. 라스트 오더는 9시. 식사 시간에는 웨이팅이 있을수 있다.<br>
  오픈은 매월 첫째,셋째주 월요일은 5시 </h4>
<input type="button" value="CLICK" onClick="window.open('http://www.santa-lucia.co.kr/')">
