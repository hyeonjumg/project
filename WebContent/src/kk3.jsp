...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>해외음식</i></h1>
  <img src="img/hh3.png" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 더리스</h3>
<h4> 소나무 숲 사이로 들어서 있는 이곳은 푸른 대청호를 바라보며 식사를<br>
하실 수 있어 가족 단위 나들이 장소로도 많이 사랑받고 있습니다.<br>
각종 고기와 야채, 과일 등을 꼬치에 꽂아 구워 먹는 브라질의 대중적인 전통 꼬치 슈하스코!
</h4>
<input type="button" value="CLICK" onClick="window.open('https://thelees.modoo.at/')">
