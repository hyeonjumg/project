...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>레스토랑</i></h1>
  <img src="img/str9.jpg" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 싼타루치아</h3>
<h4>42층에서 통유리로 야경을 감상할 수 있는 이탈리안 레스토랑입니다. 영화 과속 스캔들에서 유명 가수(차태현 역)의<br>
 집으로 나왔던 오피스텔 건물의 꼭대기에 위치하고 있지요. 저녁 시간에는 라이브 피아노 연주를 들을 수 있다고 합니다.<br>
  밤에는 와인바로 운영되고 있습니다.</h4>
