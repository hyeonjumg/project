...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
 		...
 		<div class="container">
 		<br><br><br>
 		<h3 style="text-align: left;">고객센터</h3>
 			<div class="row">
 			<form method="post" action="customwriteAction.jsp">
 			<table class="table table-striped" style="text-align: center;  border: 1px solid #dddddd">
 						...
 						<tbody>
 							<tr>
 								<td><input type="text" class="form-control" placeholder="글 제목" name="customTitle" maxlength="50"></td>
 								</tr>
 								<tr>
 								<td><textarea class="form-control" placeholder="글 내용" name="customContent" maxlength="2048" style="height: 350px;"></textarea></td>
 								</tr>
