...
<body>
	<%
		...
		if (!userID.equals(custom2.getUserID())) {
			...
			if (request.getParameter("custom2Title") == null || request.getParameter("custom2Content") == null
					|| request.getParameter("custom2Title").equals("") || request.getParameter("custom2Content").equals("")) {
					PrintWriter script = response.getWriter();
					script.println("<script>");
					...
					int result = custom2DAO.update(custom2ID, request.getParameter("custom2Title"), request.getParameter("custom2Content"));
					if (result == -1) {
						PrintWriter script = response.getWriter();
						script.println("<script>");
