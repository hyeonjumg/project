...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>레스토랑</i></h1>
  <img src="img/str10.jpg" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 트리플튜에</h3>
<h4>홈메이드 스타일로 만들어 내는 시카고 피자와 파스타가 있는 작지만 아늑한 송도의 피자, 파스타 전문점입니다.<br>
 치즈 토핑의 시카고 피자와 자체 소스로 만들어 내놓는 파스타가 주메뉴입니다. 실내는 유럽 아일랜드풍으로<br>
  이색적인 분위기가 감도는 곳입니다. 좋은 평가를 자랑하고 있습니다.</h4>
