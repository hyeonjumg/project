 ...
 */
 var Y_point = 37.5197436; // Y 좌표
 var X_point = 127.4578408; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "옥천냉면 황해식당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>옥천냉면 황해식당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 양평군 옥천면 옥천리 760<br />' +
 'Tel. Tel 031) 772-9693</p>'
 '</div>' +
 '</div>';
