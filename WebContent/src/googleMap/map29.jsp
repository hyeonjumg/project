 ...
 */
 var Y_point = 38.1971935; // Y 좌표
 var X_point = 128.5354417; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "크래프트루트"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>크래프트루트</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 속초시 노학동 980-41<br />' +
 'Tel. 070-8872-1001</p>'
 '</div>' +
 '</div>';
