 ...
 */
 var Y_point = 37.5255689; // Y 좌표
 var X_point = 127.052824; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "새벽집 청담동점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>새벽집 청담동점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 도산대로101길 6<br />' +
 'Tel. Tel 02) 546-5739</p>'
 '</div>' +
 '</div>';
