 ...
 */
 var Y_point = 37.4754278; // Y 좌표
 var X_point = 126.6177979; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "신승반점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>신승반점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 중구 차이나타운로26번길<br />' +
 'Tel. 032) 762-9467</p>'
 '</div>' +
 '</div>';
