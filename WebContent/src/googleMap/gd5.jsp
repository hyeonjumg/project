 ...
 */
 var Y_point = 35.8680916; // Y 좌표
 var X_point = 128.5992022; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "빈플러스"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>빈플러스</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 중구 동성로4길 73<br />' +
 'Tel. 053-242-3582</p>'
 '</div>' +
 '</div>';
