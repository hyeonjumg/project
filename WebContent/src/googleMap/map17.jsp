 ...
 */
 var Y_point = 35.0997243; // Y 좌표
 var X_point = 129.0296121; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "아인스크레페"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>아인스크레페</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 중구 광복동2가 18-3<br />' +
 'Tel. 010) 4216-9116</p>'
 '</div>' +
 '</div>';
