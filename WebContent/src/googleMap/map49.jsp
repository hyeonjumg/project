 ...
 */
 var Y_point = 36.3266928; // Y 좌표
 var X_point = 127.4144775; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "성심당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>성심당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 중구 은행동 대종로480번길 15<br />' +
 'Tel. 1588-8069</p>'
 '</div>' +
 '</div>';
