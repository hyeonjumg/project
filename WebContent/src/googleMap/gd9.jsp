 ...
 */
 var Y_point = 35.8645203; // Y 좌표
 var X_point = 128.6170267; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "윤옥연원조할매떡볶이"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>윤옥연원조할매떡볶이</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 수성구 범어천로 216-11<br />' +
 'Tel. 053-756-7579</p>'
 '</div>' +
 '</div>';
