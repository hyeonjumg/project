 ...
 */
 var Y_point = 37.3087541; // Y 좌표
 var X_point = 127.6433222; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "만두정육점생고기식당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>만두정육점생고기식당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 여주시 가남읍 태평로 68<br />' +
 'Tel. Tel 031) 884-7221</p>'
 '</div>' +
 '</div>';
