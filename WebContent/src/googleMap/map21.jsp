 ...
 */
 var Y_point = 35.1633907; // Y 좌표
 var X_point = 129.1663026; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "소문난암소갈비집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>소문난암소갈비집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 해운대구 중동2로10번길 32-10<br />' +
 'Tel. 051) 746-0033</p>'
 '</div>' +
 '</div>';
