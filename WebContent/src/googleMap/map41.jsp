 ...
 */
 var Y_point = 37.7966784; // Y 좌표
 var X_point = 128.914641; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "카페폴앤메리"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>카페폴앤메리</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 강릉시 강문동 창해로350번길 33<br />' +
 'Tel. 033-653-2354</p>'
 '</div>' +
 '</div>';
