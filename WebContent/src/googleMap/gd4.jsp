 ...
 */
 var Y_point = 35.8709543; // Y 좌표
 var X_point = 128.598092; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "해밥달밥"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>해밥달밥</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 남구 두류공원로 62<br />' +
 'Tel. 053-624-1177</p>'
 '</div>' +
 '</div>';
