 ...
 */
 var Y_point = 37.3176329; // Y 좌표
 var X_point = 127.6473282; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "홍원막국수"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>홍원막국수</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 여주군 여주읍 오학리 85-4<br />' +
 'Tel. Tel 031) 885-0559</p>'
 '</div>' +
 '</div>';
