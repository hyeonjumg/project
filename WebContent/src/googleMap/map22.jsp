 ...
 */
 var Y_point = 38.2299879; // Y 좌표
 var X_point = 128.583021; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "카페 나폴리아"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>카페 나폴리아</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 속초시 장사동 477<br />' +
 'Tel. 033-638-7007</p>'
 '</div>' +
 '</div>';
