 ...
 */
 var Y_point = 35.8683913; // Y 좌표
 var X_point = 128.5934829; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "삼송빵집 본점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>삼송빵집 본점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 중구 중앙대로 395<br />' +
 'Tel. 053-254-4064</p>'
 '</div>' +
 '</div>';
