 ...
 */
 var Y_point = 36.3521137; // Y 좌표
 var X_point = 127.374713; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "홀리크로스"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>홀리크로스</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 서구 둔산동 984<br />' +
 'Tel. 042-485-4688</p>'
 '</div>' +
 '</div>';
