 ...
 */
 var Y_point = 35.8830537; // Y 좌표
 var X_point = 128.5609254; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "기찻길삼겹살"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>기찻길삼겹살</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 서구 달서천로 232<br />' +
 'Tel. 010-2877-7547</p>'
 '</div>' +
 '</div>';
