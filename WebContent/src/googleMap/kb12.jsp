 ...
 */
 var Y_point = 36.1191968; // Y 좌표
 var X_point = 128.1254599; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "중국만두"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>중국만두</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 김천시 용두동 163-4<br />' +
 'Tel. 054-434-2581</p>'
 '</div>' +
 '</div>';
