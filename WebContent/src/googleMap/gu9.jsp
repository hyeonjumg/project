 ...
 */
 var Y_point = 35.1251055; // Y 좌표
 var X_point = 126.8784884; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "베비에르"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>베비에르</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 서구 풍암중앙로 37 그랜드프라자<br />' +
 'Tel. 062-682-0696</p>'
 '</div>' +
 '</div>';
