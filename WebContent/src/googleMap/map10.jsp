 ...
 */
 var Y_point = 35.1624205; // Y 좌표
 var X_point = 129.1645061; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "금수복국"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>금수복국</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 해운대구 중동1로43번길 23 금수복국<br />' +
 'Tel. 032) 933-8403</p>'
 '</div>' +
 '</div>';
