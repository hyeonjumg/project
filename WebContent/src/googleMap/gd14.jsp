 ...
 */
 var Y_point = 35.8782685; // Y 좌표
 var X_point = 128.6063884; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "수봉반점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>수봉반점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 북구 대현남로2길 60<br />' +
 'Tel. 053-941-1503</p>'
 '</div>' +
 '</div>';
