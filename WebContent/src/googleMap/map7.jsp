 ...
 */
 var Y_point = 35.1485335; // Y 좌표
 var X_point = 129.1138403; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "언양불고기부산집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>언양불고기부산집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 수영구 남천바다로 32<br />' +
 'Tel. 051) 754-1004</p>'
 '</div>' +
 '</div>';
