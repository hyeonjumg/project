 ...
 */
 var Y_point = 35.119328; // Y 좌표
 var X_point = 126.8578794; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "김강심칼국수"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>김강심칼국수</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 서구 회재로 841<br />' +
 'Tel. 062-682-0801</p>'
 '</div>' +
 '</div>';
