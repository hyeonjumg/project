 ...
 */
 var Y_point = 35.1555601; // Y 좌표
 var X_point = 129.0602441; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "화전국수"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>화전국수</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 부산진구 중앙대로702번길 17-2<br />' +
 'Tel. 051) 806-2259</p>'
 '</div>' +
 '</div>';
