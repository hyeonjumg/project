 ...
 */
 var Y_point = 37.8926352; // Y 좌표
 var X_point = 127.7210395; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "자매키친"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>자매키친</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 춘천시 근화동 당간지주길 71-15<br />' +
 'Tel. 033-251-2283</p>'
 '</div>' +
 '</div>';
