 ...
 */
 var Y_point = 36.4142014; // Y 좌표
 var X_point = 128.2143328; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "명실상감한우"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>명실상감한우</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 상주시 헌신동 45-1<br />' +
 'Tel. 054-531-9911</p>'
 '</div>' +
 '</div>';
