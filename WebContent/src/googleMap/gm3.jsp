 ...
 */
 var Y_point = 37.4020832; // Y 좌표
 var X_point = 127.0059714; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "열두대문"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>열두대문</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 의왕시 청계로 167-16<br />' +
 'Tel. Tel 031) 426-1236</p>'
 '</div>' +
 '</div>';
