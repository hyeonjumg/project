 ...
 */
 var Y_point = 35.1424675; // Y 좌표
 var X_point = 129.1096731; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "와사비"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>와사비</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 남구 자성로 148<br />' +
 'Tel. 051) 643-7972</p>'
 '</div>' +
 '</div>';
