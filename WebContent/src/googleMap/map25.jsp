 ...
 */
 var Y_point = 38.2028886; // Y 좌표
 var X_point = 128.5662365; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "봉브레드"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>봉브레드</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 속초시 교동 799-173<br />' +
 'Tel. 033-633-4826</p>'
 '</div>' +
 '</div>';
