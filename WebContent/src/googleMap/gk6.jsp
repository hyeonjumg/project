 ...
 */
 var Y_point = 37.4439739; // Y 좌표
 var X_point = 126.7032404; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "와규홀릭"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>와규홀릭</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 남동구 구월1동 1474-2<br />' +
 'Tel. 032) 432-5070</p>'
 '</div>' +
 '</div>';
