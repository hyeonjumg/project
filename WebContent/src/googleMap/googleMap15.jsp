 ...
 */
 var Y_point = 37.5234143; // Y 좌표
 var X_point = 127.0305884; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "일일향 1호점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>일일향 1호점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 신사동 논현로168길 30<br />' +
 'Tel. Tel 02) 545-6154</p>'
 '</div>' +
 '</div>';
