 ...
 */
 var Y_point = 35.6391196; // Y 좌표
 var X_point = 129.0904404; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "기와집숯불고기"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>기와집숯불고기</i></h3>' +
 '<div id="bodyContent">' +
 '<p>울산광역시 울주군 두동면 봉계리 539-1 <br />' +
 'Tel. 052-262-7288</p>'
 '</div>' +
 '</div>';
