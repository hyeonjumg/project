 ...
 */
 var Y_point = 37.5257531; // Y 좌표
 var X_point = 127.0472658; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "팔레드고몽"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>팔레드고몽</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 도산대로81길 21<br />' +
 'Tel. Tel 02) 546-8877</p>'
 '</div>' +
 '</div>';
