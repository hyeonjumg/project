 ...
 */
 var Y_point = 35.7184579; // Y 좌표
 var X_point = 127.0099386; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "락원가든"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>락원가든</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 전라북도 김제시 금산면 금산리 471-1<br />' +
 'Tel. 063-543-3738</p>'
 '</div>' +
 '</div>';
