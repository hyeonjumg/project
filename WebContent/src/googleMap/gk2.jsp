 ...
 */
 var Y_point = 37.4427112; // Y 좌표
 var X_point = 126.4304335; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "해송쌈밥"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>해송쌈밥</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 중구 공항서로 177<br />' +
 'Tel. 032) 747-0073</p>'
 '</div>' +
 '</div>';
