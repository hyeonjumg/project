 ...
 */
 var Y_point = 35.1334321; // Y 좌표
 var X_point = 126.909602; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "시골집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>시골집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 남구 대남대로139번길 4-6 평화인테리어<br />' +
 'Tel. 062-652-3082</p>'
 '</div>' +
 '</div>';
