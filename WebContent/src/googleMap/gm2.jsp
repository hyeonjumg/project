 ...
 */
 var Y_point = 37.4170952; // Y 좌표
 var X_point = 127.1318582; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "홍박사생고기"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>홍박사생고기</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 성남시 분당구 양현로 447<br />' +
 'Tel. Tel 031) 703-0778</p>'
 '</div>' +
 '</div>';
