 ...
 */
 var Y_point = 35.5549592; // Y 좌표
 var X_point = 129.3213968; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "더파티울산점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>더파티울산점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>울산광역시 중구 옥교동 120-2<br />' +
 'Tel. 052-241-5500</p>'
 '</div>' +
 '</div>';
