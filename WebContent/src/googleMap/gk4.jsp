 ...
 */
 var Y_point = 37.462932; // Y 좌표
 var X_point = 126.714276; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "부암갈비"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>부암갈비</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 남동구 용천로 149<br />' +
 'Tel. 032) 425-5538</p>'
 '</div>' +
 '</div>';
