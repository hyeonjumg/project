 ...
 */
 var Y_point = 36.388908; // Y 좌표
 var X_point = 127.4252422; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "꽁뚜"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>꽁뚜</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 대덕구 연축동 69-5<br />' +
 'Tel. 042-483-9999</p>'
 '</div>' +
 '</div>';
