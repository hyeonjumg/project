 ...
 */
 var Y_point = 35.0967024; // Y 좌표
 var X_point = 129.0311202; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "달봉이횟집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>달봉이횟집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 중구 자갈치해안로 52<br />' +
 'Tel. 051) 256-3340</p>'
 '</div>' +
 '</div>';
