 ...
 */
 var Y_point = 37.5059881; // Y 좌표
 var X_point = 127.0525341; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "경천애인2237"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>경천애인2237</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 테헤란로 421<br />' +
 'Tel. Tel 02) 553-2237</p>'
 '</div>' +
 '</div>';
