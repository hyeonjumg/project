 ...
 */
 var Y_point = 35.8183927; // Y 좌표
 var X_point = 127.1450065; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "PNB풍년제과본점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>PNB풍년제과본점</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 전라북도 전주시 완산구 풍남동 팔달로 180<br />' +
 'Tel. 063-285-6666</p>'
 '</div>' +
 '</div>';
