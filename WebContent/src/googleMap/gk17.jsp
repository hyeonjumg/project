 ...
 */
 var Y_point = 37.416773; // Y 좌표
 var X_point = 126.7298081; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "가라비칼국수"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>가라비칼국수</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 남동구 도림동 636-2<br />' +
 'Tel. 032) 432-0030</p>'
 '</div>' +
 '</div>';
