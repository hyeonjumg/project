 ...
 */
 var Y_point = 35.1547126; // Y 좌표
 var X_point = 126.8504903; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "금다연한정식"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>금다연한정식</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 서구 상무연하로 72 골든유토피아<br />' +
 'Tel. 062-374-1000</p>'
 '</div>' +
 '</div>';
