 ...
 */
 var Y_point = 37.5026132; // Y 좌표
 var X_point = 126.9044609; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "호수 삼계탕"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>호수 삼계탕</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 영등포구 신길동 342-325<br />' +
 'Tel. Tel 02) 831-4111</p>'
 '</div>' +
 '</div>';
