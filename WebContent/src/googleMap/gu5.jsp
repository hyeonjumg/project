 ...
 */
 var Y_point = 35.1502798; // Y 좌표
 var X_point = 126.9433649; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "명선헌"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>명선헌</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 동구 지호로127번길 11<br />' +
 'Tel. 062-228-2942</p>'
 '</div>' +
 '</div>';
