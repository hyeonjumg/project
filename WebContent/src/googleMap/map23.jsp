 ...
 */
 var Y_point = 37.892702; // Y 좌표
 var X_point = 127.6882088; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "대원당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>대원당</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 춘천시 효자1동 679-16<br />' +
 'Tel. 033-254-8187</p>'
 '</div>' +
 '</div>';
