 ...
 */
 var Y_point = 36.3176816; // Y 좌표
 var X_point = 127.4540033; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "부여순대"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>부여순대</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 동구 판암동 동부로 5<br />' +
 'Tel. 042-282-3091</p>'
 '</div>' +
 '</div>';
