 ...
 */
 var Y_point = 37.2780171; // Y 좌표
 var X_point = 127.0407814; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "본수원갈비"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>본수원갈비</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 수원시 팔달구 중부대로223번길 41<br />' +
 'Tel. Tel 031) 211-8434 </p>'
 '</div>' +
 '</div>';
