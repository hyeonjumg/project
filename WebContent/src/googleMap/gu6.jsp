 ...
 */
 var Y_point = 35.145659; // Y 좌표
 var X_point = 126.911651; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "거목한정식"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>거목한정식</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 남구 천변좌로364번길 3-6 <br />' +
 'Tel. 062-672-0333</p>'
 '</div>' +
 '</div>';
