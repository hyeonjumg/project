 ...
 */
 var Y_point = 37.5207606; // Y 좌표
 var X_point = 126.926893; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "진주집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>진주집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 영등포구 여의도동 36-2<br />' +
 'Tel. Tel 02) 780-6108</p>'
 '</div>' +
 '</div>';
