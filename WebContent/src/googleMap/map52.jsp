 ...
 */
 var Y_point = 37.522257; // Y 좌표
 var X_point = 127.0390983; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "밍글스"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>밍글스</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 선릉로 757 더채플앳 청담<br />' +
 'Tel. Tel 02) 515-7306</p>'
 '</div>' +
 '</div>';
