 ...
 */
 var Y_point = 35.8319644; // Y 좌표
 var X_point = 128.7103102; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "뺑드깜빠뉴"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>뺑드깜빠뉴</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 수성구 달구벌대로652길 69-5<br />' +
 'Tel. 053-792-0445</p>'
 '</div>' +
 '</div>';
