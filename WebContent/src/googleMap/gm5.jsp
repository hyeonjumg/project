 ...
 */
 var Y_point = 37.4547448; // Y 좌표
 var X_point = 127.1059706; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "토지한정식"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>토지한정식</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 성남시 수정구 오야로 5<br />' +
 'Tel. Tel 031) 723-6054</p>'
 '</div>' +
 '</div>';
