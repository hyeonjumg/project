 ...
 */
 var Y_point = 35.5408292; // Y 좌표
 var X_point = 129.3444207; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "난스시"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>난스시</i></h3>' +
 '<div id="bodyContent">' +
 '<p>울산광역시 남구 삼산동 정동로80번길 22 <br />' +
 'Tel. 052-269-3548</p>'
 '</div>' +
 '</div>';
