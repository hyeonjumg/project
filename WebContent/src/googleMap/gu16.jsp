 ...
 */
 var Y_point = 35.1389741; // Y 좌표
 var X_point = 126.7947954; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "송정떡갈비"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>송정떡갈비</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 광산구 광산로29번길 1<br />' +
 'Tel. 062-944-1439</p>'
 '</div>' +
 '</div>';
