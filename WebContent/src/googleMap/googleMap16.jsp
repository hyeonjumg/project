 ...
 */
 var Y_point = 37.493179; // Y 좌표
 var X_point = 126.9893246; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "주"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>주</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울특별시 서초구 동광로19길 16<br />' +
 'Tel. Tel 02) 3482-3374</p>'
 '</div>' +
 '</div>';
