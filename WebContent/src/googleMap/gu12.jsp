 ...
 */
 var Y_point = 35.1660717; // Y 좌표
 var X_point = 126.8119103; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "나주곰탕하얀집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>나주곰탕하얀집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 광산구 월곡산정로 89<br />' +
 'Tel. 062-953-0893</p>'
 '</div>' +
 '</div>';
