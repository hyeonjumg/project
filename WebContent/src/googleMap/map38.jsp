 ...
 */
 var Y_point = 37.3802578; // Y 좌표
 var X_point = 129.224565; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "문화제과"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>문화제과</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 삼척시 근덕면 교가길 14<br />' +
 'Tel. 033-572-3100</p>'
 '</div>' +
 '</div>';
