 ...
 */
 var Y_point = 36.340191; // Y 좌표
 var X_point = 127.3953293; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "살구나무집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>살구나무집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 서구 용문동 아랫강변9길 15<br />' +
 'Tel. 042-526-0306</p>'
 '</div>' +
 '</div>';
