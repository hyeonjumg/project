 ...
 */
 var Y_point = 37.4626909; // Y 좌표
 var X_point = 126.6670992; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "청해김밥"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>청해김밥</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 미추홀구 경인로 414<br />' +
 'Tel. 032) 429-7212</p>'
 '</div>' +
 '</div>';
