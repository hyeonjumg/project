 ...
 */
 var Y_point = 36.871291; // Y 좌표
 var X_point = 128.5249289; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "정도너츠"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>정도너츠</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 영주시 풍기읍 동양대로 6-1<br />' +
 'Tel. 054-636-0067</p>'
 '</div>' +
 '</div>';
