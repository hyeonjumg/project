 ...
 */
 var Y_point = 37.4492666; // Y 좌표
 var X_point = 126.7109156; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "안승베이커리구월본점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>안승베이커리구월본점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 남동구 인주대로 664 메인프라자 2차<br />' +
 'Tel. 032) 463-0045</p>'
 '</div>' +
 '</div>';
