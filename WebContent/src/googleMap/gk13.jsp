 ...
 */
 var Y_point = 37.3956872; // Y 좌표
 var X_point = 126.6507098; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "아띠오아나폴리핏제리아"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>아띠오아나폴리핏제리아</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 연수구 컨벤시아대로 69<br />' +
 'Tel. 032) 834-7222</p>'
 '</div>' +
 '</div>';
