 ...
 */
 var Y_point = 35.5353916; // Y 좌표
 var X_point = 126.9916628; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "더집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>더집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 중구 대흥동 249-1 15<br />' +
 'Tel. 042-257-3140</p>'
 '</div>' +
 '</div>';
