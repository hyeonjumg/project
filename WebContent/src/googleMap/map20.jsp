 ...
 */
 var Y_point = 35.1660473; // Y 좌표
 var X_point = 129.1142315; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "이하정간장게장"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>이하정간장게장</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산 수영구 광서로10번길 46<br />' +
 'Tel. 051) 909-6100</p>'
 '</div>' +
 '</div>';
