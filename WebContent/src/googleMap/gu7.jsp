 ...
 */
 var Y_point = 35.1468802; // Y 좌표
 var X_point = 126.8525458; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "홍아네"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>홍아네</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 서구 마륵복개로150번길 7<br />' +
 'Tel. 062-384-9401</p>'
 '</div>' +
 '</div>';
