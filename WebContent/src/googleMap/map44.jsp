 ...
 */
 var Y_point = 36.3259363; // Y 좌표
 var X_point = 127.4208837; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "서울치킨"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>서울치킨</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 중구 대흥동 471-1<br />' +
 'Tel. 042-252-7333</p>'
 '</div>' +
 '</div>';
