 ...
 */
 var Y_point = 37.3928514; // Y 좌표
 var X_point = 126.6456307; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "트러플듀에"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>트러플듀에</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 연수구 송도동 22-22 21<br />' +
 'Tel. 070-7723-2323</p>'
 '</div>' +
 '</div>';
