 ...
 */
 var Y_point = 36.3528042; // Y 좌표
 var X_point = 127.3775868; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "토끼정 둔산점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>병규돈까스</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 서구 대덕대로 226 명동 프라자 1 층<br />' +
 'Tel. 042-472-5585</p>'
 '</div>' +
 '</div>';
