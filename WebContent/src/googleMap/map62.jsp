 ...
 */
 var Y_point = 36.3536615; // Y 좌표
 var X_point = 127.3750772; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "설해돈"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>설해돈</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 서구 둔산2동 993<br />' +
 'Tel. 042-484-1119</p>'
 '</div>' +
 '</div>';
