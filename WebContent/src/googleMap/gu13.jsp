 ...
 */
 var Y_point = 35.0964538; // Y 좌표
 var X_point = 126.9072915; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "조선옥"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>조선옥</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 남구 효덕로 105<br />' +
 'Tel. 062-654-3322</p>'
 '</div>' +
 '</div>';
