 ...
 */
 var Y_point = 37.7046741; // Y 좌표
 var X_point = 126.3903565; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "충남서산집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>충남서산집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 강화군 중앙로 1200<br />' +
 'Tel. 032) 933-8403</p>'
 '</div>' +
 '</div>';
