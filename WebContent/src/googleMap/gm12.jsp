 ...
 */
 var Y_point = 37.4093418; // Y 좌표
 var X_point = 126.9727583; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "고래빵"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>고래빵</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 안양시 동안구 동편로49번길 19<br />' +
 'Tel. Tel 031) 423-1625</p>'
 '</div>' +
 '</div>';
