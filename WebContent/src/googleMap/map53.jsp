 ...
 */
 var Y_point = 37.5085873; // Y 좌표
 var X_point = 127.0236601; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "리복집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>리북집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 학동로2길 47<br />' +
 'Tel. Tel 02) 540-8589</p>'
 '</div>' +
 '</div>';
