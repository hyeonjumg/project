 ...
 */
 var Y_point = 37.7461429; // Y 좌표
 var X_point = 126.4839017; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "우리옥"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>우리옥</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 강화군 강화읍 신문리 184-1<br />' +
 'Tel. 032) 934-2427</p>'
 '</div>' +
 '</div>';
