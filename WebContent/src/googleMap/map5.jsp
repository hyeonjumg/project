 ...
 */
 var Y_point = 35.16279; // Y 좌표
 var X_point = 129.162838; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "옵스 해운대점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>옵스 해운대점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 해운대구 중동1로 31<br />' +
 'Tel. 051) 747-6886</p>'
 '</div>' +
 '</div>';
