 ...
 */
 var Y_point = 37.6409219; // Y 좌표
 var X_point = 126.4197135; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "편가네된장"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>편가네된장</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 강화군 가능포로89번길 11 편가네된장<br />' +
 'Tel. 032) 937-6479</p>'
 '</div>' +
 '</div>';
