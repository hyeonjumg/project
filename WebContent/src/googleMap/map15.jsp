 ...
 */
 var Y_point = 35.1022106; // Y 좌표
 var X_point = 129.0305856; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "이재모피자"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>이재모피자</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산시 중구 신창동1가 2-1<br />' +
 'Tel. 051) 245-1478</p>'
 '</div>' +
 '</div>';
