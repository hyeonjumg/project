 ...
 */
 var Y_point = 37.9729432; // Y 좌표
 var X_point = 128.7570113; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "파머스키친"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>파머스키친</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 양양군 현남면 시변리 27-1<br />' +
 'Tel. 033-671-0955</p>'
 '</div>' +
 '</div>';
