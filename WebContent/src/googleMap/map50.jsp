 ...
 */
 var Y_point = 36.3335795; // Y 좌표
 var X_point = 127.4253576; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "왕관식당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>왕관식당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 동구 중동 선화로196번길 6<br />' +
 'Tel. 042-221-1663</p>'
 '</div>' +
 '</div>';
