 ...
 */
 var Y_point = 35.1893747; // Y 좌표
 var X_point = 126.8230198; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "타오"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>타오</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 광산구 임방울대로 327<br />' +
 'Tel. 062-955-2215</p>'
 '</div>' +
 '</div>';
