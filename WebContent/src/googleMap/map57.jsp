 ...
 */
 var Y_point = 37.484918; // Y 좌표
 var X_point = 127.0951592; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "필경재"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>필경재</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 광평로 205<br />' +
 'Tel. Tel 02) 445-2115</p>'
 '</div>' +
 '</div>';
