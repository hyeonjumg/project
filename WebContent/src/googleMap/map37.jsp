 ...
 */
 var Y_point = 37.8776574; // Y 좌표
 var X_point = 127.7248547; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "꼬삔이식빵"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>꼬삔이식빵</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 춘천시 약사명동 중앙로77번길 17<br />' +
 'Tel. 033-242-9840</p>'
 '</div>' +
 '</div>';
