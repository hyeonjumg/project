 ...
 */
 var Y_point = 35.8661776; // Y 좌표
 var X_point = 128.5961016; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "도쿄다이닝"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>도쿄다이닝</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 중구 동성로2길 4-5<br />' +
 'Tel. 053-424-9191</p>'
 '</div>' +
 '</div>';
