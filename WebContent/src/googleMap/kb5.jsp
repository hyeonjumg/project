 ...
 */
 var Y_point = 36.0325085; // Y 좌표
 var X_point = 129.3626114; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "엘토로원조구룡포과메기"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>엘토로원조구룡포과메기</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 포항시 북구 죽도동 죽도로40번길 7-1<br />' +
 'Tel. 054-275-1772</p>'
 '</div>' +
 '</div>';
