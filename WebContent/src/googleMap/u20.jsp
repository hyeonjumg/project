 ...
 */
 var Y_point = 35.5178952; // Y 좌표
 var X_point = 129.4290634; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "북경통닭"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>북경통닭</i></h3>' +
 '<div id="bodyContent">' +
 '<p>울산광역시 동구 전하1동 300-264 <br />' +
 'Tel. 052-233-0880</p>'
 '</div>' +
 '</div>';
