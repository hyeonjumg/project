 ...
 */
 var Y_point = 35.1637956; // Y 좌표
 var X_point = 126.8974578; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "연화식당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>연화식당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 서구 마륵복개로 147 아트빌<br />' +
 'Tel. 062-384-1142</p>'
 '</div>' +
 '</div>';
