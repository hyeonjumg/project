 ...
 */
 var Y_point = 36.3204006; // Y 좌표
 var X_point = 127.4256483; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "복수분식"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>복수분식</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 중구 대흥동 382-1<br />' +
 'Tel. 042-253-6518</p>'
 '</div>' +
 '</div>';
