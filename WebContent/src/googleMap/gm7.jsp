 ...
 */
 var Y_point = 37.2796246; // Y 좌표
 var X_point = 127.0181731; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "진미통닭"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>진미통닭</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 수원시 팔달구 정조로800번길 21<br />' +
 'Tel. Tel 031) 225-3401</p>'
 '</div>' +
 '</div>';
