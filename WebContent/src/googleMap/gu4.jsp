 ...
 */
 var Y_point = 35.1904229; // Y 좌표
 var X_point = 126.818775; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "나정상회"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>나정상회</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 서구 상무자유로 24<br />' +
 'Tel. 062-944-1489</p>'
 '</div>' +
 '</div>';
