 ...
 */
 var Y_point = 37.8357789; // Y 좌표
 var X_point = 126.7454932; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "길릴리농원"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>길릴리농원</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 파주시 탄현면 방촌로 1196<br />' +
 'Tel. Tel 031) 942-8400</p>'
 '</div>' +
 '</div>';
