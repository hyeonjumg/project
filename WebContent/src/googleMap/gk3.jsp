 ...
 */
 var Y_point = 37.505742; // Y 좌표
 var X_point = 126.702275; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "정아식당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>정아식당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 부평구 산곡1동 170-1<br />' +
 'Tel. 032) 513-1576</p>'
 '</div>' +
 '</div>';
