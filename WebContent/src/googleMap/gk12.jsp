 ...
 */
 var Y_point = 37.7238962; // Y 좌표
 var X_point = 126.5127329; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "일미산장어"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>일미산장어</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 강화군 더리미길 2<br />' +
 'Tel. 032) 933-8585</p>'
 '</div>' +
 '</div>';
