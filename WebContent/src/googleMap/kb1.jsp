 ...
 */
 var Y_point = 35.8557717; // Y 좌표
 var X_point = 129.2029144; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "티룸바이11체스터필드웨이"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>티룸바이11체스터필드웨이</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 경주시 성건동 620-495<br />' +
 'Tel. 010-3628-7045</p>'
 '</div>' +
 '</div>';
