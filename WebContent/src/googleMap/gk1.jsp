 ...
 */
 var Y_point = 37.426181; // Y 좌표
 var X_point = 126.4211945; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "황해해물칼국수"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>황해해물칼국수</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 중구 용유로21번길 3<br />' +
 'Tel. Tel 032) 746-3017</p>'
 '</div>' +
 '</div>';
