 ...
 */
 var Y_point = 35.5554313; // Y 좌표
 var X_point = 129.3168139; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "미락식당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>미락식당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>울산광역시 중구 성남동 149-4 <br />' +
 'Tel. 052-245-7984</p>'
 '</div>' +
 '</div>';
