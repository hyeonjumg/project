 ...
 */
 var Y_point = 35.1269392; // Y 좌표
 var X_point = 126.9176513; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "옛날밥상"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>옛날밥상</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 남구 용대로119번길 6 옛날밥상<br />' +
 'Tel. 062-653-7337</p>'
 '</div>' +
 '</div>';
