 ...
 */
 var Y_point = 37.39876; // Y 좌표
 var X_point = 126.6521595; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "통꼬집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>통꼬집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 연수구 송도동 15-10<br />' +
 'Tel. 032) 831-9282</p>'
 '</div>' +
 '</div>';
