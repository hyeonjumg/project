 ...
 */
 var Y_point = 35.1556719; // Y 좌표
 var X_point = 129.0584822; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "송정3대국밥"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>송정3대국밥</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 부산진구 서면로68번길 29<br />' +
 'Tel. 051) 806-7181</p>'
 '</div>' +
 '</div>';
