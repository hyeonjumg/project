 ...
 */
 var Y_point = 37.7309408; // Y 좌표
 var X_point = 127.0475165; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "평양면옥"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>평양면옥</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 의정부시 평화로439번길 7<br />' +
 'Tel. Tel 031) 877-2282</p>'
 '</div>' +
 '</div>';
