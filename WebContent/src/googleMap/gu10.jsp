 ...
 */
 var Y_point = 35.186105; // Y 좌표
 var X_point = 126.8283097; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "유향"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>유향</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 광산구 수완로11번길 3<br />' +
 'Tel. 062-954-9530</p>'
 '</div>' +
 '</div>';
