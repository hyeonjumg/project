 ...
 */
 var Y_point = 37.488132; // Y 좌표
 var X_point = 126.779374; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "크라이치즈버거 심곡점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>크라이치즈버거 심곡점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 부천시 신흥로52번길 35<br />' +
 'Tel. Tel 032) 611-6244</p>'
 '</div>' +
 '</div>';
