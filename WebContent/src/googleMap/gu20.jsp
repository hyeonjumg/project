 ...
 */
 var Y_point = 35.1496413; // Y 좌표
 var X_point = 126.944058; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "남가정"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>남가정</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 동구 지호로 137-7<br />' +
 'Tel. 062-652-3082</p>'
 '</div>' +
 '</div>';
