 ...
 */
 var Y_point = 36.4777875; // Y 좌표
 var X_point = 127.2551644; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "도안동감나무집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>도안동감나무집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 유성구 복용동 368-1<br />' +
 'Tel. 042-822-2366</p>'
 '</div>' +
 '</div>';
