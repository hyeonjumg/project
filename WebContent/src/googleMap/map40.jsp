 ...
 */
 var Y_point = 37.7707565; // Y 좌표
 var X_point = 128.9479189; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "산토리니커피"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>산토리니커피</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 강릉시 견소동 경강로 2667<br />' +
 'Tel. 033-653-0931</p>'
 '</div>' +
 '</div>';
