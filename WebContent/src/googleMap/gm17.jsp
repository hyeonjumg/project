 ...
 */
 var Y_point = 37.3743067; // Y 좌표
 var X_point = 127.0061923; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "올라 백운호수 2호점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>올라 백운호수2호점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 의왕시 의일로 25<br />' +
 'Tel. Tel 031) 426-1008</p>'
 '</div>' +
 '</div>';
