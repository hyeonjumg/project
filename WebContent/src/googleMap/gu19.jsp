 ...
 */
 var Y_point = 35.1444024; // Y 좌표
 var X_point = 126.9295632; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "무진장떡볶이"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>무진장떡볶이</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 동구 필문대로287번길 24-14<br />' +
 'Tel. 062-232-8369</p>'
 '</div>' +
 '</div>';
