 ...
 */
 var Y_point = 37.6834307; // Y 좌표
 var X_point = 127.1015492; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "목향원"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>목향원</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 남양주시 덕릉로1071번길 34-11<br />' +
 'Tel. Tel 031) 527-2255</p>'
 '</div>' +
 '</div>';
