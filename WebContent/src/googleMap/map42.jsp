 ...
 */
 var Y_point = 36.3266932; // Y 좌표
 var X_point = 127.4210275; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "초록지붕"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>초록지붕</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 중구 대흥동 491-3<br />' +
 'Tel. 042-226-4415</p>'
 '</div>' +
 '</div>';
