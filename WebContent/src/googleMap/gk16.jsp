 ...
 */
 var Y_point = 37.6154241; // Y 좌표
 var X_point = 126.6865974; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "권오길손국수본점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>권오길손국수본점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 서구 검단로 789 권오길 손국수<br />' +
 'Tel. 032) 564-7541</p>'
 '</div>' +
 '</div>';
