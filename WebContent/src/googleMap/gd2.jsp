 ...
 */
 var Y_point = 35.8685297; // Y 좌표
 var X_point = 128.6067343; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "왕거미식당"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>왕거미식당</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 중구 국채보상로 696-8<br />' +
 'Tel. 053-427-6380</p>'
 '</div>' +
 '</div>';
