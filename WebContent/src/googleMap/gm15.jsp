 ...
 */
 var Y_point = 37.3849256; // Y 좌표
 var X_point = 127.11153; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "뀌숑"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>뀌숑</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 성남시 분당구 판교역로14번길 16<br />' +
 'Tel. Tel 031) 8017-9793</p>'
 '</div>' +
 '</div>';
