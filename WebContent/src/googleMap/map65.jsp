 ...
 */
 var Y_point = 36.3654908; // Y 좌표
 var X_point = 127.377829; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "한스랍스타"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>한스랍스타</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 서구 만년동 282<br />' +
 'Tel. 042-864-3700</p>'
 '</div>' +
 '</div>';
