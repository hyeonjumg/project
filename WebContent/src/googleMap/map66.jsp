 ...
 */
 var Y_point = 36.327124; // Y 좌표
 var X_point = 127.4196968; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "바로그집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>바로그집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 중구 대흥동 중앙로 지하145<br />' +
 'Tel. 042-254-8925</p>'
 '</div>' +
 '</div>';
