 ...
 */
 var Y_point = 37.4890195; // Y 좌표
 var X_point = 126.7234865; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "모녀떡볶이"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>모녀떡볶이</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 부평구 광장로 16<br />' +
 'Tel. 032) 504-9636</p>'
 '</div>' +
 '</div>';
