 ...
 */
 var Y_point = 37.8682502; // Y 좌표
 var X_point = 126.7517945; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "반구정나루터"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>반구정나루터</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 파주시 문산읍 반구정로85번길 13<br />' +
 'Tel. Tel 031) 952-3472</p>'
 '</div>' +
 '</div>';
