 ...
 */
 var Y_point = 35.8320434; // Y 좌표
 var X_point = 128.6170634; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "호남정"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>호남정</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 수성구 들안로 24<br />' +
 'Tel. 053-767-9555</p>'
 '</div>' +
 '</div>';
