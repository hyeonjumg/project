 ...
 */
 var Y_point = 35.8449279; // Y 좌표
 var X_point = 129.2565559; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "한우리가든"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>한우리가든</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 경주시 보문동 21-31<br />' +
 'Tel. 054-772-9999</p>'
 '</div>' +
 '</div>';
