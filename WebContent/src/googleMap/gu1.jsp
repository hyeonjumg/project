 ...
 */
 var Y_point = 35.2367029; // Y 좌표
 var X_point = 126.8542934; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "넓으실"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>넓으실</i></h3>' +
 '<div id="bodyContent">' +
 '<p>광주광역시 북구 대촌길6번길 20-6<br />' +
 'Tel. 062-972-8201</p>'
 '</div>' +
 '</div>';
