 ...
 */
 var Y_point = 37.5249394; // Y 좌표
 var X_point = 127.0477365; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "모통이우"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>모통이우</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 영동대로96길 26 하나은행삼성동<br />' +
 'Tel. Tel 02) 517-4654</p>'
 '</div>' +
 '</div>';
