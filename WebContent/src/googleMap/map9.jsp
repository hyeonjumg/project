 ...
 */
 var Y_point = 35.1853522; // Y 좌표
 var X_point = 129.2114084; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "기장곰장어"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>기장곰장어</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 기장군 기장해안로 70 기장곰장어<br />' +
 'Tel. 051) 721-2934</p>'
 '</div>' +
 '</div>';
