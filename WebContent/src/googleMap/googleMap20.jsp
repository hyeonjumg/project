 ...
 */
 var Y_point = 37.5048111; // Y 좌표
 var X_point = 127.027168; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "랩 24"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>랩 24</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 봉은사로 120 르메르디앙서울호텔<br />' +
 'Tel. Tel 02) 511-4523</p>'
 '</div>' +
 '</div>';
