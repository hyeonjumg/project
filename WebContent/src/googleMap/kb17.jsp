 ...
 */
 var Y_point = 36.5654744; // Y 좌표
 var X_point = 128.7256361; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "안동유진찜닭"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>안동유진찜닭</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 안동시 남문동 222-7<br />' +
 'Tel. 054-854-6019</p>'
 '</div>' +
 '</div>';
