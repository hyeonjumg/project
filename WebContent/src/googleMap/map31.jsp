 ...
 */
 var Y_point = 38.0233807; // Y 좌표
 var X_point = 128.7204719; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "싱글핀에일웍스"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>싱글핀에일웍스</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 양양군 하조대2길 48-42<br />' +
 'Tel. 033-672-1155</p>'
 '</div>' +
 '</div>';
