 ...
 */
 var Y_point = 36.0031467; // Y 좌표
 var X_point = 128.6043073; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "인디안참숯구이"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>인디안참숯구이</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 칠곡군 동명면 기성리 469<br />' +
 'Tel. 054-977-6869</p>'
 '</div>' +
 '</div>';
