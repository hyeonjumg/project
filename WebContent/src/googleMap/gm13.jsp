 ...
 */
 var Y_point = 37.3904682; // Y 좌표
 var X_point = 126.9491764; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "이웃사촌"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>이웃사촌</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 안양시 동안구 시민대로 161 안양무역센터<br />' +
 'Tel. Tel 031) 388-8640</p>'
 '</div>' +
 '</div>';
