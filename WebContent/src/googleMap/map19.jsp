 ...
 */
 var Y_point = 35.1172108; // Y 좌표
 var X_point = 129.0406063; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "초량밀면"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>초량밀면</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 동구 중앙대로 225<br />' +
 'Tel. 051) 462-1575</p>'
 '</div>' +
 '</div>';
