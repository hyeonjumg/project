 ...
 */
 var Y_point = 37.6704451; // Y 좌표
 var X_point = 126.7861314; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "일산칼국수본점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>일산칼국수본점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>경기도 고양시 일산동구 경의로 467<br />' +
 'Tel. Tel 031) 903-2208</p>'
 '</div>' +
 '</div>';
