 ...
 */
 var Y_point = 35.1610037; // Y 좌표
 var X_point = 129.1841088; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "속시원한대구탕"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>속시원한대구탕</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 해운대구 달맞이길 229 삼우가든<br />' +
 'Tel. 051) 747-1666</p>'
 '</div>' +
 '</div>';
