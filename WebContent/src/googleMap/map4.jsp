 ...
 */
 var Y_point = 35.163905; // Y 좌표
 var X_point = 129.1632924; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "해성막창집 본점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>해성막창집 본점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 해운대구 중동1로19번길 29<br />' +
 'Tel. 051) 731-3113</p>'
 '</div>' +
 '</div>';
