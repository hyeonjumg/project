 ...
 */
 var Y_point = 35.197521; // Y 좌표
 var X_point = 129.2231481; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "풍원장시골밥상"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>풍원장시골밥상</i></h3>' +
 '<div id="bodyContent">' +
 '<p>부산광역시 기장군 동암1길 5 우물집돼지갈비<br />' +
 'Tel. 051) 937-6479</p>'
 '</div>' +
 '</div>';
