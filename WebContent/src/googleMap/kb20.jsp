 ...
 */
 var Y_point = 36.6551768; // Y 좌표
 var X_point = 128.4516366; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "청포집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>청포집</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 예천군 예천읍 남본리 222-23<br />' +
 'Tel. 054-655-0264</p>'
 '</div>' +
 '</div>';
