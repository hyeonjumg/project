 ...
 */
 var Y_point = 37.5099679; // Y 좌표
 var X_point = 127.1261994; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "벽제갈비 방이본점"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>벽제갈비 방이본점</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 송파구 방이1동 양재대로71길 1-4<br />' +
 'Tel. Tel 02) 415-5522</p>'
 '</div>' +
 '</div>';
