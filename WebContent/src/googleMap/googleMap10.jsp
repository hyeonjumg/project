 ...
 */
 var Y_point = 37.5174422; // Y 좌표
 var X_point = 127.0213268; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "목포집"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>목포집</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 강남구 신사동 강남대로152길 24<br />' +
 'Tel. Tel 02) 549-5119</p>'
 '</div>' +
 '</div>';
