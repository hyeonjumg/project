 ...
 */
 var Y_point = 37.7662908; // Y 좌표
 var X_point = 128.9048724; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "엄지네포장마차"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>엄지네포장마차</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 강릉시 포남동 경강로2255번길 21<br />' +
 'Tel. 033-642-0178</p>'
 '</div>' +
 '</div>';
