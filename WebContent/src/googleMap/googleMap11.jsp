 ...
 */
 var Y_point = 37.498047; // Y 좌표
 var X_point = 127.002058; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "스와니예"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>스와니예</i></h3>' +
 '<div id="bodyContent">' +
 '<p>서울 서초구 반포동 반포대로39길 46<br />' +
 'Tel. Tel 02) 3477-9386</p>'
 '</div>' +
 '</div>';
