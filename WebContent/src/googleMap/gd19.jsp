 ...
 */
 var Y_point = 35.8740319; // Y 좌표
 var X_point = 128.5873131; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "원조북성로우동불고기"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>원조북성로우동불고기</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대구광역시 중구 서성로 72<br />' +
 'Tel. 010-9989-9199</p>'
 '</div>' +
 '</div>';
