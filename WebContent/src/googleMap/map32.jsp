 ...
 */
 var Y_point = 37.7481182; // Y 좌표
 var X_point = 128.8821743; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "버드나무브루어리"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>버드나무브루어리</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 강원도 강릉시 경강로 1961, 홍제동 93-8<br />' +
 'Tel. 033-920-9380</p>'
 '</div>' +
 '</div>';
