 ...
 */
 var Y_point = 36.8317128; // Y 좌표
 var X_point = 128.5029774; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "미소머금고"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>미소머금고</i></h3>' +
 '<div id="bodyContent">' +
 '<p> 경상북도 영주시 봉현면 대촌리<br />' +
 'Tel. 054-636-1599</p>'
 '</div>' +
 '</div>';
