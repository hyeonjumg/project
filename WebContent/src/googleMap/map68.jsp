 ...
 */
 var Y_point = 36.3619904; // Y 좌표
 var X_point = 127.3507763; // X 좌표
 var zoomLevel = 18; // 첫 로 딩시 보일 지도의 확대 레벨
 var markerTitle = "누오보나폴리"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 var markerMaxWidth = 300; // 마커를 클릭했을때 나타나는 말풍선의 최대 크기

 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>누오보나폴리</i></h3>' +
 '<div id="bodyContent">' +
 '<p>대전광역시 유성구 궁동 406-10<br />' +
 'Tel. 042-322-9582</p>'
 '</div>' +
 '</div>';
