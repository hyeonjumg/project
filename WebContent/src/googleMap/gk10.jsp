 ...
 */
 var Y_point = 37.4828457; // Y 좌표
 var X_point = 126.687499; // X 좌표
 var zoomLevel = 18; // 첫 로딩시 보일 지도의 확대 레벨
 var markerTitle = "학운정"; // 현재 위치 마커에 마우스를 올렸을때 나타나는 이름
 ...
 '<div id="siteNotice">' +
 '</div>' +
 '<h3 id="firstHeading" class="firstHeading"><i>학운정</i></h3>' +
 '<div id="bodyContent">' +
 '<p>인천광역시 서구 열우물로208번길 12<br />' +
 'Tel. 032) 584-8584</p>'
 '</div>' +
 '</div>';
