...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>해외음식</i></h1>
  <img src="img/hh6.png" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 바그다드</h3>
<h4>진한 인도 커리가 생각날때는 인도 요리 전문점 바그다드<br>
제주 시청 부근에 위치한 이곳은 이밎 방송으로도 방영되어 많은 인기를 누리고 있고<br>
인도 느낌이 물씬 풍기는 외관과 내부 인테리어, 인도 음악 등이 인도향을 전달해<br>
주고 있으며, 커리와 난, 탄두리 치킨을 선보이고 있는 곳이랍니다.
</h4>
<input type="button" value="CLICK" onClick="window.open('https://www.facebook.com/bagdadcafejeju')">
