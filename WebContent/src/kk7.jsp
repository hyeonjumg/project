...
<h3> 매장 명 : 화이트하우스</h3>
<h4>울산에서 터키 음식이 먹고 싶을땐 화이트하우스!<br>
전체적인 분위기가 터키풍으로 꾸며져 있으며 무슬림 친화 레스토랑으로 외국인들도<br>
많은 방문하는 곳입니다. 터키 출신 세프가 요리하는 정통 터키 요리들을 맛볼 수 있습니다.
</h4>
<input type="button" value="CLICK" onClick="window.open('http://www.istanbulwhitehouse.net/')">
