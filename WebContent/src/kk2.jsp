...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>해외음식</i></h1>
  <img src="img/hh2.png" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 베이징코야</h3>
<h4> 일산에서 만나는 정통 북경오리구이 음식점!<br>
베이징코야는 중국의 유명한 오리구이 전문점이며, 기술을 전수받아 오픈한 음식점<br>
다양한 자장면,짬뽕부터 시작해 해삼,새우,상어 지느러미 등 70여 가지의 다양한 정통 중국요리를<br>
만나 볼 수 있고 특히 세계 3대 요리 중 하나인 북경오리구이를 추천!
</h4>
<input type="button" value="CLICK" onClick="window.open('http://www.베이징코야.com/')">
