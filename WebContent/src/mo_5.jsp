...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>모범맛집</i></h1>
  <img src="img/mo_5.jpg" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 삼진어묵 부산역점</h3>
<h4>부산역사 1층에 위치한 삼진어묵은 부담 없는 가격에 여러 종류의 어묵을 즐길 수 있습니다.<br>
매장에서 직접 만들어서 튀겨낸 어묵은 매장 가득 진열되어 있어 마치 빵집처럼 트레이에 원하는 종류를 직접 고르고,<br>
 인기 메뉴는 치즈, 새우, 카레, 땡초, 감자, 고구마 어묵고로케입니다. 선물용으로 좋은 수제 어묵과 국, 볶음용 어묵도 판매<br>
  테이크 아웃 전용 매장으로 테이블이 따로 마련되어 있지 않으니 편하게 드시면 됩니다.
</h4>
