...
<body>
  ...
  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	...
	<div id="container">
  <h1><i>해외음식</i></h1>
  <img src="img/hh5.png" class="myImage"/>
<hr width =50% color="gray" align="left" size=5/>
<h3> 매장 명 : 산토리니</h3>
<h4> 푸른 하늘과 하얀 풍경이 어우러진 레스토랑 산토리니!<br>
춘천의 대표 레스토랑인 이곳은 이탈리아 산토리니 마을을 그대로 재현한 분위기로 굳이 여행을<br>
하지 않아도 외국 감성을 물씬 느끼게 할  수 있습니다. 이탈리아 토스카나 지방의 가정식 요리로<br>
신선한 재료들과 함께 풍미를 살린 음식을 선보이는 이탈리안 레스토랑
</h4>
<input type="button" value="CLICK" onClick="window.open('http://춘천산토리니.com/')">
