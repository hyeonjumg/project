...
<h3> 매장 명 : 바이로이트</h3>
<h4> 독일을 생각하면 가장 먼저 떠오르는 음식 바로 수제소시지와 맥주!<br>
남해에 가면 바이로이트에서 맛있는 독일식 음식들을 만날 수 있습니다.<br>
직접만든 소시지와 독일 대표 요리 슈바인학센 등을 판매하며 다양한 종류의 맥주를 판매
</h4>
<input type="button" value="CLICK" onClick="window.open('http://knanastory.com/484')">
